...
<head>
    ...
    <title>Sign up : Deposit system</title>
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form method="post" id="signup-form" class="signup-form" action="save_register.php">
                        <h2 class="form-title">Create account</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Your Firstname" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="last" id="last" placeholder="Your Lastname" required>
                        </div>
                        <div class="form-group">
